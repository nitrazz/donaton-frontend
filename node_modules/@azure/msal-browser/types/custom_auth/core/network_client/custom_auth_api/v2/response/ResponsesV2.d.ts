...
export interface AuthorizeChallengeEntryResponseV2 extends OAuthErrorResponseV2 {
...
export interface SignUpStartResponseV2 extends Omit<HalResponseBaseV2, "_links"> {
...
export type VerificationChallengeResponseV2 = CodeChallengeResponseV2 | PasswordChallengeResponseV2;
export interface RiskVerificationRequiredResponseV2 extends ChallengeResponseBaseV2 {
    _links?: {
        riskverify?: HalLink;
    };
}
export type ChallengeResponseV2 = VerificationChallengeResponseV2 | RiskVerificationRequiredResponseV2;
export type RiskVerificationResponseV2 = CodeChallengeResponseV2;
export interface SignUpSubmitAttributesResponseV2 extends Omit<CodeChallengeResponseV2, "_links"> {
    attributes?: SignUpAttributeResponseV2[];
    _links?: {
        verify?: HalLink;
        resend?: HalLink;
...
export interface UpdatePasswordResponseV2 extends Omit<HalResponseBaseV2, "_links"> {
    id?: string;
    type?: string;
    payload?: Record<string, unknown>;
    _links?: {
...
export {};
//# sourceMappingURL=ResponsesV2.d.ts.map