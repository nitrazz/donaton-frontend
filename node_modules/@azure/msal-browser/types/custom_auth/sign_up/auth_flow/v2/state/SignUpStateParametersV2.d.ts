...
export interface SignUpActionRequiredStateParametersV2 extends CustomAuthActionRequiredStateParametersV2 {
    signUpStateTransitionHandler: SignUpStateTransitionHandlerV2;
}
export interface AttributesRequiredStateParametersV2 extends SignUpActionRequiredStateParametersV2 {
    attributes: SignUpAttributeV2[];
}
export interface SignUpPasswordRequiredStateParametersV2 extends SignUpActionRequiredStateParametersV2 {
    attributes: SignUpAttributeV2[];
    requiredPasswordAttribute: SignUpAttributeV2;
}
//# sourceMappingURL=SignUpStateParametersV2.d.ts.map