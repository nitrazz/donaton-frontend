 ...
 */
function resolveHrefV2(base, href) {
    ...
    try {
        ...
        throw new ParsedUrlError(InvalidUrl, `The HAL href "${href}" could not be resolved: ${e}`);
    }
    if (resolved.protocol !== "http:" && resolved.protocol !== "https:") {
        throw new ParsedUrlError(InvalidUrl, `The HAL href "${href}" must use the HTTP or HTTPS protocol`);
    }
...
function tryParseAbsolute(href) {
    try {
...
export { resolveHrefV2 };
//# sourceMappingURL=HrefResolverV2.mjs.map
