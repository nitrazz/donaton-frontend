...
const AUTHORIZE_CHALLENGE = "/oauth2/v2.0/authorize-challenge";
...
export { AUTHORIZE_CHALLENGE, REGISTER_CHALLENGE, REGISTER_CONTINUE, REGISTER_INTROSPECT, RESET_PWD_CHALLENGE, RESET_PWD_CONTINUE, RESET_PWD_POLL, RESET_PWD_START, RESET_PWD_SUBMIT, SIGNIN_CHALLENGE, SIGNIN_INITIATE, SIGNIN_INTROSPECT, SIGNIN_TOKEN, SIGNUP_CHALLENGE, SIGNUP_CONTINUE, SIGNUP_START };
