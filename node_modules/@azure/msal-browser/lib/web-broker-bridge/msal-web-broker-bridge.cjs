 ...
 * @internal
 */
const PairwiseBrokerApplicationInitializeBrokering = "pairwiseBrokerApplicationInitializeBrokering";
const BrokerClientApplicationHandleBrokerHandshake = "brokerClientApplicationHandleBrokerHandshake";
const BrokerClientApplicationBrokeredSSOSilentRequest = "brokerClientApplicationBrokeredSSOSilentRequest";
const BrokerClientApplicationBrokeredSilentRequest = "brokerClientApplicationBrokeredSilentRequest";
const EmbeddedClientApplicationSendSSOSilentRequest = "embeddedSSOSilent";
const EmbeddedClientApplicationSendPopupRequest = "embeddedPopup";
const EmbeddedClientApplicationHandleRedirectRequest = "embeddedHandleRedirect";
const EmbeddedClientApplicationSendSilentRefreshRequest = "embeddedSilentRefresh";
const EmbeddedSendSilentRefreshRequestInternal = "embeddedSilentRefreshInternal";
const SendHandshakeRequest = "sendHandshakeRequest";
const SendMessageToBroker = "sendMessageToBroker";
const SendRequest = "sendRequest";
const HandleResponse = "handleBrokerResponse";
const GetFrameDepth = "getFrameDepth";
const OnHandshakeResponse = "onHandshakeResponse";
const HandleBrokerMessage = "handleBrokerMessage";
const PostMessageToAllDescendantFrames = "postMessageToAllDescendantFrames";
const HandleBrokerAuthRequest = "handleBrokerAuthRequest";
const BrokeredSilentRequest = "brokeredSilentRequest";
const BrokeredSsoSilentRequest = "brokeredSsoSilentRequest";
const BrokeredRedirectRequest = "brokeredRedirectRequest";
const BrokeredPopupRequest = "brokeredPopupRequest";
const InteractiveBrokerRequest = "interactiveBrokerRequest";
const AcquireTokenByBroker = "acquireTokenByBroker";

exports.AcquireTokenByBroker = AcquireTokenByBroker;
exports.BrokerClientApplicationBrokeredSSOSilentRequest = BrokerClientApplicationBrokeredSSOSilentRequest;
exports.BrokerClientApplicationBrokeredSilentRequest = BrokerClientApplicationBrokeredSilentRequest;
exports.BrokerClientApplicationHandleBrokerHandshake = BrokerClientApplicationHandleBrokerHandshake;
exports.BrokeredPopupRequest = BrokeredPopupRequest;
exports.BrokeredRedirectRequest = BrokeredRedirectRequest;
exports.BrokeredSilentRequest = BrokeredSilentRequest;
exports.BrokeredSsoSilentRequest = BrokeredSsoSilentRequest;
exports.EmbeddedClientApplicationHandleRedirectRequest = EmbeddedClientApplicationHandleRedirectRequest;
exports.EmbeddedClientApplicationSendPopupRequest = EmbeddedClientApplicationSendPopupRequest;
exports.EmbeddedClientApplicationSendSSOSilentRequest = EmbeddedClientApplicationSendSSOSilentRequest;
exports.EmbeddedClientApplicationSendSilentRefreshRequest = EmbeddedClientApplicationSendSilentRefreshRequest;
exports.EmbeddedSendSilentRefreshRequestInternal = EmbeddedSendSilentRefreshRequestInternal;
exports.GetFrameDepth = GetFrameDepth;
exports.HandleBrokerAuthRequest = HandleBrokerAuthRequest;
exports.HandleBrokerMessage = HandleBrokerMessage;
exports.HandleResponse = HandleResponse;
exports.InteractiveBrokerRequest = InteractiveBrokerRequest;
exports.OnHandshakeResponse = OnHandshakeResponse;
exports.PairwiseBrokerApplicationInitializeBrokering = PairwiseBrokerApplicationInitializeBrokering;
exports.PendingRequestRegistry = PendingRequestRegistry;
exports.PostMessageToAllDescendantFrames = PostMessageToAllDescendantFrames;
exports.SendHandshakeRequest = SendHandshakeRequest;
exports.SendMessageToBroker = SendMessageToBroker;
