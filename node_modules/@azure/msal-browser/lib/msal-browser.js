...
(function (global, factory) {
    ...
    /*! @azure/msal-common v16.14.1 2026-09-23 */
    /*
     ...
     */
    const PlatformAuthTokenType = {
        DPOP_WITH_PROOF: "dpop+proof",
    };
    const PROOF_OF_POSSESSION_TOKEN_TYPES = [
        AuthenticationScheme$1.POP,
        AuthenticationScheme$1.DPOP,
    ...
    class PlatformAuthDOMHandler {
        ...
        initializePlatformDOMRequest(request) {
            ...
            const { accountId, clientId, authority, scope, redirectUri, correlationId, state, preferBinding, enclave, reqCnf, extraParametersNoCache, extraParameters, ...remainingProperties } = request;
        ...
        parseDOMBoolean(value, propertyName, correlationId) {
            ...
            throw createAuthError(unexpectedError, correlationId, `Platform broker returned invalid ${propertyName} value.`);
        }
    ...
    class RedirectClient extends StandardInteractionClient {
        ...
        async acquireToken(request) {
            ...
            try {
                const redirectOperation = this.config.system.protocolMode === ProtocolMode.EAR
